...
function Home () {
  ...
  // const { data, isFetching } = useGetUserCourses()
            ...
            {selectedCourse && (
              <div className='flex flex-col gap-3 order-1 md:order-2'>
                <div className='w-full h-64 sm:h-96 md:h-full'>
                  <iframe
                    src='https://player.vdocipher.com/v2/?otp=20160313versASE323yddQYXJjMQmy9V02IzARI3NeqzccDTIX23ifeHpur5hLbq&playbackInfo=eyJ2aWRlb0lkIjoiMzhhMTBiODM5NDQyNDI5N2JhYWE1YzQ3OWQzNjE4YjEifQ=='
                    style={{
                      border: 0,
                      borderRadius: 32,
                      width: '100%',
