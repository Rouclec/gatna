          ...
          <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-center px-0 lg:px-32 mx-auto">
            <div className="relative md:order-1 order-2 h-full">
              <div className="grid gap-6 px-4">
                <p className="font-readex font-bold text-3xl md:text-[32px] w-full">
                  Formation axé sur le trading des cryptomonnaies sur gatna.io
                </p>
                <p className={`${gilroyRegular.className} text-lg md:text-2xl`}>
                  {`Achetez vos formations crypto et devenez un trader professionnel rentable sur les marchés financiers. Vendez nos formations et obtenez jusqu’à 10% des commissions sur l’ensemble de vos ventes.`}
                </p>
